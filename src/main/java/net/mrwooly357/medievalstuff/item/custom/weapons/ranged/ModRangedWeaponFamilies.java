...
public enum ModRangedWeaponFamilies implements RangedWeaponFamily {
    ...
    ModRangedWeaponFamilies(int extraDurability, float extraChargeTime, float extraShotPower, float extraAccuracy, float extraCriticalChance, int extraRange) {

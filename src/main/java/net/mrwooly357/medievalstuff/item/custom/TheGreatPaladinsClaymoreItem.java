...
import net.mrwooly357.medievalstuff.util.Math;
...
public class TheGreatPaladinsClaymoreItem extends AdvancedSweepMeleeWeaponItem {
    ...
    public void postDamageEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (Math.getDistanceBetween(target.getX(), target.getY(), target.getZ(), attacker.getX(), attacker.getY(), attacker.getZ()) > 3.25F) {

...
public enum ModRangedWeaponMaterials implements RangedWeaponMaterial {
    ...
    ModRangedWeaponMaterials(int baseDurability, float baseChargeTime, float baseShotPower, float baseAccuracy, float baseCriticalChance, int baseRange, Supplier<Ingredient> repairIngredient) {

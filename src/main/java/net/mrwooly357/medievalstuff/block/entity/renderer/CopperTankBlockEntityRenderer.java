...
public class CopperTankBlockEntityRenderer implements BlockEntityRenderer<CopperTankBlockEntity> {

    public CopperTankBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(CopperTankBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
